...
/*   Updated: 2024/05/13 17:44:43 by ana-cast         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief This function creates a new string (duplicate) and allocates enough
 * memory for it to create a copy of str inside it. 
 * Then it copies the string str into the new string (duplicate) by iterating
 * and copying one by one each character of str.
 ...
 * Finally we copy len number of characters of str one by one into the new substr
 * string starting from the character of str at the position start.
